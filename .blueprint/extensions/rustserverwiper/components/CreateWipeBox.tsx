...
import createOrUpdateWipe from './api/createOrUpdateWipe';
...
import ScheduleFieldRow from './ScheduleFieldRow';
            ...
            validationSchema={object().shape({
                ...
                time: date()
                    ...
                    .when(['schedule', 'repeat'], {
                        is: (schedule, repeat) => schedule === true && repeat.length === 0,
                        then: date()
                            .required()
                ...
                <TitledGreyBox title={'Create Wipe'}>
                    <Form css={tw`m-0`}>
                        <div css={tw`flex`}>
                            ...
                            <Button
                                css={tw`ml-2 w-2/5 my-auto whitespace-nowrap`}
                                type={'button'}
                                color={'grey'}
                                size={'large'}
                        ...
                        <div css={tw`flex mt-5`}>
                            <div css={tw`w-4/5`}>
                                <TextareaField
                                    ...
                                    label={'Files'}
                                    description={
                                        'All the files and directories which should be removed on this wipe. You can use * as a wildcard, like: /server/rust/*.map to delete all .map files in the /server/rust directory. Keep in mind that using wildcards will extend the time it takes to wipe your server. NOTE: nothing is deleted by itself, if you want to wipe your map, you will need to specify your map files here.'
                                    }
                                    rows={5}
                                    disabled={isSubmitting}
                                />
                            ...
                            <>
                                <div css={tw`mt-5`}>
                                    <Field
                                        ...
                                        disabled={isSubmitting || values.repeat.length !== 0}
                                    />
                                </div>
                                <div css={tw`mt-5`}>
                                    <Label>Repeat Wipe</Label>
                                    <ScheduleFieldRow week={1} />
                                    <ScheduleFieldRow week={2} />
                                    <ScheduleFieldRow week={3} />
                                    <ScheduleFieldRow week={4} />
                                    <ScheduleFieldRow week={5} />
                                    <p css={tw`mt-1 text-xs text-neutral-200`}>
                                        Repeating a wipe is only possible without a schedule time set.
                                    </p>
                                </div>
                                <div css={tw`mt-5`}>
