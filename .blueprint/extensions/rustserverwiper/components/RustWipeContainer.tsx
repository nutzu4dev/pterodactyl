...
import CreateWipeBox from './CreateWipeBox';
import TimezoneBox from './TimezoneBox';
import ScheduledWipesBox from './ScheduledWipesBox';
import WipeMapsBox from './WipeMapsBox';
import useSWR from 'swr';
import getWipeData, { WipeData } from './api/getWipeData';
